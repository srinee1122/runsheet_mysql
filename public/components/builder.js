...
export default {
  ...
  methods: {
    ...
    async loadVersionForReview(versionRow) {
      ...
      this.viewingVersion = { version: v.version, displayNumber: versionRow.displayNumber, saved_by: v.saved_by, saved_at: v.saved_at };
  ...
  <div class="warn-banner" v-if="viewingVersion">
    Reviewing version {{ viewingVersion.displayNumber }}, saved by {{ viewingVersion.saved_by || 'someone' }} at {{ formatDateTime(viewingVersion.saved_at) }}
